...
def _attn_forward_slotted(
    ...
    **kwargs
    ...
    dest_slot: torch.Tensor | None = kwargs.get("dest_slot")
    ...
    if prefill_inputs is None: # decode
        ...
        attn_output = flash_attn_varlen_func(
            q, k, v,
            cu_seqlens_q=prefill_inputs.cu_seqlens,
            cu_seqlens_k=prefill_inputs.cu_seqlens,
            max_seqlen_q=prefill_inputs.max_seqlen,
            max_seqlen_k=prefill_inputs.max_seqlen,
            causal=True
        )

        slotcache.k[self.layer_idx][dest_slot, prefill_inputs.position_ids] = k
        slotcache.v[self.layer_idx][dest_slot, prefill_inputs.position_ids] = v
